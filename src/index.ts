...
export { usePrefersDarkMode } from "@/hooks/use-prefers-dark-mode";
export { usePrefersHighContast } from "@/hooks/use-prefers-high-contast";
export { usePrefersLowContrast } from "@/hooks/use-prefers-low-contrast";
export { usePrefersReducedMotion } from "@/hooks/use-prefers-reduced-motion";
export { usePrefersReducedTransparancy } from "@/hooks/use-prefers-reduced-transparancy";
